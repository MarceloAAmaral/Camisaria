...
import com.example.camisaria_ads.database.DatabaseHelper;
...
public class EditarFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.camisas_fragment_editar, container, false);
        ...
        btnExcluir.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                builder.setTitle(R.string.certeza_disso_msm);
                builder.setPositiveButton(R.string.sim_msm, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        excluir(id_camisa);
                    }
                });
                builder.setNegativeButton(R.string.nao_msm, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //nada a fazer
                    }
